...
const generateScheduleRows = () => {
  const hours = [
    "7:00 AM", "8:30 AM", "9:00 AM", "10:30 AM", "11:00 AM",
    "12:30 PM", "1:00 PM", "2:30 PM", "3:00 PM", "4:30 PM",
    "5:00 PM", "6:30 PM", "7:00 PM", "8:30 PM", "9:00 PM"
  ];
...
const formatClassName = (className) => {
  const formattedNames = {
    "mineria": "Minería de Datos",
    "arquitectura": "Arquitectura Cliente Servidor",
    "sistemas": "Sistemas Distribuidos",
    "redes": "Redes de Datos Seguras",
    "lab_micro": "Lab de Microcomputadoras",
    "microcomputadoras": "Microcomputadoras"
  };
